...
import devindetailsCreation from '../../public/images/dev-in-details_001_md.jpg'
import devindetailsH5P from '../../public/images/dev-in-details_002_md.jpg'
...
export default function DevInDetails() {
  return (<Layout className="relative lg:flex lg:flex-wrap md:overflow-x-hidden md:overflow-y-visible">
    ...
    <section id="timeline" className="relative z-[5] basis-full pb-24">
      <h2 className="text-2xl font-extrabold text-center mb-8">Project Timeline</h2>
      <Timeline steps={[
        { 
          ...
          cover: () => (<NextJSLogo className="fill-white-medium drop-shadow-[0_5px_5px_rgba(0,0,0,0.6)]"/>)
        },
        {
          title: 'H5P Activities Integration',
          date: '2020-08-31',
          description: 'To increase user engagement with my blog, I integrated the H5P suite of activities that allowed me to make the posts interactives.',
          cover: () => (<Image 
            src={devindetailsH5P}
...
function NextJSLogo({...props}) {
  return (<>
    <svg aria-label="Next.js logotype" height="68" role="img" viewBox="0 0 394 79" width="339" {...props}>
      <title>Next.js</title>
